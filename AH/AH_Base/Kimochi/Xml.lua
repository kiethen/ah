...
XmlParser = {
    ...
    ToXmlString = function(self, value)
    ...
    FromXmlString = function(self, value)
    ...
    ParseArgs = function(self, node, s)
...
<frame name="test name">
	<window name="window_name" w="100" h="200">
		<label name="label_name" w="200" text="test label" />
		<button name="button_name" w="120" text="click me" />
	</window>
</frame>
]]
--local parser = XmlParser:ParseXmlText(xmlString)
--print(parser.frame.window["@name"])
